...
MeshSK::MeshSK(ModelSK& model, aiMesh& mesh)
...
ModelSK& MeshSK::GetModel()
{
	return mModel;
}

ModelMaterial* MeshSK::GetMaterial()
{
	return mMaterial;
}

const std::string& MeshSK::Name() const
{
	return mName;
}

const std::vector<XMFLOAT3>& MeshSK::Vertices() const
{
	return mVertices;
}

const std::vector<XMFLOAT3>& MeshSK::Normals() const
{
	return mNormals;
}

const std::vector<XMFLOAT3>& MeshSK::Tangents() const
{
	return mTangents;
}

const std::vector<XMFLOAT3>& MeshSK::BiNormals() const
{
	return mBiNormals;
}

const std::vector<std::vector<XMFLOAT3>*>& MeshSK::TextureCoordinates() const
{
	return mTextureCoordinates;
}

const std::vector<std::vector<XMFLOAT4>*>& MeshSK::VertexColors() const
{
	return mVertexColors;
}

UINT MeshSK::FaceCount() const
{
	return mFaceCount;
}

const std::vector<UINT>& MeshSK::Indices() const
{
	return mIndices;
}

const std::vector<BoneVertexWeights>& MeshSK::BoneWeights() const
{
	return mBoneWeights;
}

BufferContainer& MeshSK::VertexBuffer()
{
	return mVertexBuffer;
}

BufferContainer& MeshSK::IndexBuffer()
{
	return mIndexBuffer;
}

bool MeshSK::HasCachedVertexBuffer() const
{
	MeshSK* mesh = const_cast<MeshSK*>(this);

	return mesh->mVertexBuffer.Buffer() != nullptr;
}

bool MeshSK::HasCachedIndexBuffer() const
{
	MeshSK* mesh = const_cast<MeshSK*>(this);
...
void MeshSK::CreateIndexBuffer(ID3D11Buffer** indexBuffer)
{
