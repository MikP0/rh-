...
void DepthMapMaterial::Initialize(EffectSK& effect)
{
...
void DepthMapMaterial::CreateVertexBuffer(ID3D11Device* device, const MeshSK& mesh, ID3D11Buffer** vertexBuffer) const
{
