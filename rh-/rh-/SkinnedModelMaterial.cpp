...
SkinnedModelMaterial::SkinnedModelMaterial()
	...
	MATERIAL_VARIABLE_INITIALIZATION(Projection)//, MATERIAL_VARIABLE_INITIALIZATION(ProjectiveTextureMatrix), 
	//MATERIAL_VARIABLE_INITIALIZATION(ShadowMap), MATERIAL_VARIABLE_INITIALIZATION(ShadowMapSize)
{
}
...
//MATERIAL_VARIABLE_DEFINITION(SkinnedModelMaterial, ProjectiveTextureMatrix)
//MATERIAL_VARIABLE_DEFINITION(SkinnedModelMaterial, ShadowMap)
//MATERIAL_VARIABLE_DEFINITION(SkinnedModelMaterial, ShadowMapSize)
